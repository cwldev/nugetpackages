...
$packageName = 'CloseTheDoor' # arbitrary name for the package, used in messages
$installerType = 'EXE' #only one of these two: exe or msi
$url = 'http://downloads.sourceforge.net/project/closethedoor/v0.2.1/CloseTheDoorSetup-v0.2.1.exe' # download url
