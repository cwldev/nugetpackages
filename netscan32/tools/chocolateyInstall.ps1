...
$packageName = 'netscan32' # arbitrary name for the package, used in messages
$installerType = 'EXE' #only one of these two: exe or msi
$url = 'https://github.com/calwell/nugetpackages/raw/master/netscan32/netscan32.zip' # download url
