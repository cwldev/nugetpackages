...
$packageName = 'PDFXChangeViewer' # arbitrary name for the package, used in messages
$installerType = 'EXE' #only one of these two: exe or msi
$url = 'http://www.tracker-software.com/downloads/PDFXVwer.exe' # download url
$url64 = $url # 64bit URL here or just use the same as $url
$silentArgs = '/VERYSILENT /NOINSTASK' # "/s /S /q /Q /quiet /silent /SILENT /VERYSILENT" # try any of these to get the silent installer #msi is always /quiet
